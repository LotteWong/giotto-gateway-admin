...
type CreateOrUpdateHttpServiceReq struct {
	...
	IpList     string `json:"ip_list" form:"ip_list" comment:"启用ip列表" example:"" validate:"valid_ip_port_list"`         // 启用ip列表
...
type CreateOrUpdateTcpServiceReq struct {
	...
	IpList     string `json:"ip_list" form:"ip_list" comment:"启用ip列表" example:"" validate:"valid_ip_port_list"`      // 启用ip列表
	WeightList string `json:"weight_list" form:"weight_list" comment:"权重列表" example:"" validate:"valid_weight_list"` // 权重列表
	ForbidList string `json:"forbid_list" form:"forbid_list" comment:"禁用ip列表" validate:"valid_ip_port_list"`         // 禁用ip列表
}
